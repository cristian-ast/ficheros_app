...
class Estudiante {
  ...
  factory Estudiante.fromJson(dynamic json) {
    ...
    newEstudent.carrera = json['carrera'] as String;
...
List<dynamic> cargarFichero() {
  ...
  _newEstudiante.carrera = '-- Elije una carrera --';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String dropdownvalue = '-- Elije una carrera --';
  ...
  void limpiarCampos() {
    ...
    setState(() {
      dropdownvalue = '-- Elije una carrera --';
      gender = '';
      estadoCivil = '';
    });
  ...
  void clickEnConsultar() {
    ...
    if (encontrado) {
      ...
      setState(() {
        dropdownvalue = _estudianteActual.carrera;
  ...
  void clickEnRegistrar() {
    ...
    _estudiante.carrera = dropdownvalue;
    ...
    if (_estudiante.cedula == '' ||
        ...
        _estudiante.carrera == '-- Elije una carrera --' ||
